// Test-only single-line mesh with the production vertex layout (StyledLineTileBuilder.LineVertexDescriptors),
// its geometry generated by RibbonJob through the shared FlatRibbon harness.
//
// Non-obvious why: every field the streams read crosses into the mesh through a (float) cast, which quantises
// away the tiny managed↔Burst divergence.
