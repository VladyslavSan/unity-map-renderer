...
// dotnet core-tests project. Covers SymbolCandidate.TryFindRangeTilingViolation, the debug-invariant check that
// SymbolPlacementSystem.ScheduleCollision asserts each frame: the staged candidate box-ranges must tile
