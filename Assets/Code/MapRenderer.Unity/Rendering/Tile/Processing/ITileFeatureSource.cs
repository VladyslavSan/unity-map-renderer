...
namespace MapRenderer.Unity.Rendering.Tile.Processing
{
    ...
    public interface ITileFeatureSource : System.IDisposable
    {
        ...
        /// owns one — SYMMETRICALLY (R1).</b> A decoded tile owns <c>Allocator.Persistent</c> buffers, so it
        ...
        /// end — there is no transfer of ownership from one holder to another (R0/D1 had one: the creator's
        /// reference moved into the mesh kick; R1 deletes that machinery in favour of the kick acquiring its
        /// own). Every reference must reach exactly one release site, or the tile's
