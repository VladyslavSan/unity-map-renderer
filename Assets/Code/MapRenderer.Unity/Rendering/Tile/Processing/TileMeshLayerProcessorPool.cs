...
namespace MapRenderer.Unity.Rendering.Tile.Processing
{
    ...
    /// kick's prologue loop); <see cref="TileMeshLayerProcessor.Release"/> returns from
    ...
    /// exactly what <see cref="TileBuildBuffersPool"/>'s own doc comment explains <see cref="ConcurrentBag{T}"/>
