...
struct SymbolWorldAttributes
{
    ...
    float  alignFlags : TEXCOORD3; // bit0: map(1)/viewport(0) rotation-alignment (A3); bit1: along-line (Stage AC)
...
SymbolWorldVaryings SymbolWorldPassVertex(SymbolWorldAttributes input)
{
    ...
    if (input.alignFlags >= 1.5)
    {
        ...
        // NO extra Y-frame flip here. The A0-F2 OffsetPx.y negation (this file's header) reconciles the OLD
