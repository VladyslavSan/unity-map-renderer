...
namespace MapRenderer.Jobs.Geometry
{
    ...
    /// It is <b>never geodetic and never projected</b>. This type is <i>monomorphic</i>, so feeding
    /// earcut or ring assembly a geodetic version is a <b>compile-time impossibility</b> rather than a rule
    ...
    /// three real <see cref="NativeArray{T}"/>s, so a second owner is a <b>loud double free</b> with the
    /// heap-corruption signature. A <b>list-backed</b> buffer's
