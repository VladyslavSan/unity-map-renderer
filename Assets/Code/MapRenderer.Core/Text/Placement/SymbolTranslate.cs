...
namespace MapRenderer.Core.Text.Placement
{
    ...
    public static class SymbolTranslate
    {
        ...
        /// <paramref name="screenPx"/> from <see cref="SymbolScreenProjection.TryProjectAnchor"/> is y-UP
        ...
        /// <see cref="SymbolBearing.MapAlignedSign"/>, which is pinned by a rendered tooth on the billboard
