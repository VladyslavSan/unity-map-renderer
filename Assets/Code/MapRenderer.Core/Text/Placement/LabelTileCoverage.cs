...
// float4x4 — this file lives in MapRenderer.Core.Text.Placement (see LabelScreenProjection's header for the
...
namespace MapRenderer.Core.Text.Placement
{
    ...
    /// are camera-independent and stored once per rebuild (on <see cref="SymbolLabelBatch"/>). Corners are
    /// projected through the SAME <see cref="LabelScreenProjection.TryProjectPoint"/> the label anchors use, so
    /// the metric is globe-correct (no flat-earth / Mercator-bounds shortcut).</para>
    /// </summary>
    public static class LabelTileCoverage
    {
        /// <summary>
        ...
        /// labels — or when the viewport is degenerate.
        /// </summary>
