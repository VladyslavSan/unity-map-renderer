...
namespace MapRenderer.Core.Style.Line
{
    ...
    public sealed class PaintProperties
    {
        ...
        /// Constant/Zoom → material uniform; Feature/Composite → per-vertex bake (S12).
        /// </summary>
        public StyleProperty<float> Width { get; }
        ...
        /// </summary>
        public StyleProperty<float> Blur { get; }
        ...
        /// Constant/Zoom only.
        /// </summary>
        public StyleProperty<float> GapWidth { get; }
        ...
        /// </summary>
        public StyleProperty<float> Offset { get; }
        ...
        /// </summary>
        public Expression DashArray { get; }
        ...
        /// <summary>Parse and classify all line paint properties from the layer's <c>paint</c> sub-tree
