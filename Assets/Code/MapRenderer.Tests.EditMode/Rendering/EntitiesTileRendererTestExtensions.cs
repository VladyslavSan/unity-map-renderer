...
//
// The two Editor-only members lost their `#if UNITY_EDITOR`: this assembly's .asmdef is
// includePlatforms:["Editor"], so the guard was unconditionally true here. The guard still matters on the
