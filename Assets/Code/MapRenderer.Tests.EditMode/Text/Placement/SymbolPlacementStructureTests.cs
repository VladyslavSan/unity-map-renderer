...
namespace MapRenderer.Tests.Text.Placement
{
    ...
    /// </summary>
    [TestFixture]
    public class SymbolPlacementStructureTests
    {
        ...
        {
            var camGo = new GameObject("SymbolStructure_TestCamera");
        ...
        {
            var camGo = new GameObject("SymbolTranslate_TestCamera");
            var uCam = camGo.AddComponent<Camera>();
            uCam.targetTexture = new RenderTexture(320, 240, 0);
            var mapCamera = new MapCamera(uCam, new CameraProperties(
                new GeoCoordinate3D { Latitude = 20.0, Longitude = 20.0, Altitude = 0.0 }, zoom: 5.0, heading: 0.0, tilt: 0.0));
        ...
        {
            var camGo = new GameObject("SymbolRotation_TestCamera");
            var uCam = camGo.AddComponent<Camera>();
            uCam.targetTexture = new RenderTexture(320, 240, 0);
