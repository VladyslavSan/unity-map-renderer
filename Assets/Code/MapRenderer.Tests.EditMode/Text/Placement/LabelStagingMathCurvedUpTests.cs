...
{
    [TestFixture]
    public class LabelStagingMathCurvedUpTests
    {
        ...
        public void StageCurved_SurfaceUp_MatchesHandComputedLerpAndNormalize_AtEachGlyphsOwnSample()
        {
            ...
            // (LineAnchor(0, 0.5) -> centerArc = 50 of a 100-px total) -> labelCenterBaked = 50, so
            ...
            int staged = LabelStagingMath.StageCurved(in s, screenPath, depthPath, validPath, worldPath, worldUpPath,
