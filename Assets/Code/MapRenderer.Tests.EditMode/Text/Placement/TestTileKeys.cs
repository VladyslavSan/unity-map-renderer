...
//
// Epic A / A1 (Risk R1): AnchorLocal for TileKey=0 (tile 0/0/0) is ~2e7 m from a mid-latitude anchor —
// float32-unsafe (ULP ~2m — glyphs jitter/vanish on-screen). Every point/icon render test that previously
// used the "no real tile" placeholder TileKey=0L must instead use a
