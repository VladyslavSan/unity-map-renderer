...
namespace MapRenderer.Tests.Text.Placement
{
    ...
    public class LabelBearingTests
    {
        ...
        public void BillboardRotation_Map_IsBearingTimesSign()
        {
            ...
            Assert.AreEqual(LabelBearing.MapAlignedSign * bearing,
                LabelBearing.BillboardRotationRadians(AlignmentMode.Map, bearing), 1e-6f);
        }
        ...
        public void BillboardRotation_ViewportAndAuto_AreZero_ForAnyBearing()
        {
            ...
            Assert.AreEqual(0f, LabelBearing.BillboardRotationRadians(AlignmentMode.Viewport, bearing), 1e-6f,
                "viewport-aligned text never rotates with the map");
            Assert.AreEqual(0f, LabelBearing.BillboardRotationRadians(AlignmentMode.Auto, bearing), 1e-6f,
        ...
        {
            Assert.AreEqual(0f, LabelBearing.BillboardRotationRadians(AlignmentMode.Map, 0f), 1e-6f,
