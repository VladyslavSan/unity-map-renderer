...
{
    /// <summary>
    /// Unit tests for <c>Earcut.PointInTriangle</c>'s degenerate-candidate branch (UMR-106 Stage 1). A
    /// degenerate (collinear) candidate triangle is a segment, not the whole plane through it — these pin
    /// the bounding-box containment test that replaces the bare cross-product sign check on that branch.
    /// </summary>
    public class EarcutDegenerateTriangleTests
    {
        ...
        public void DegenerateTriangle_PointFarOnSharedLine_IsNotContained()
        {
            ...
            Assert.IsFalse(Earcut.PointInTriangle(3, -8, 3, -8, -3, -8, -11, -8));
        }
        ...
        public void DegenerateTriangle_PointOnTheHullSegment_IsContained()
        {
            ...
            Assert.IsTrue(Earcut.PointInTriangle(3, -8, 3, -8, -3, -8, 0, -8));
        }
        ...
        public void NonDegenerateTriangle_InsideAndOutsidePoints_AreUnchanged()
        {
            ...
            Assert.IsTrue(Earcut.PointInTriangle(0, 0, 4, 0, 0, 4, 1, 1));
            Assert.IsFalse(Earcut.PointInTriangle(0, 0, 4, 0, 0, 4, 5, 5));
        }
        ...
        public void DegenerateTriangle_OnDiagonalHull_BoundingBoxIsTwoDimensional()
        {
            ...
            Assert.IsFalse(Earcut.PointInTriangle(0, 0, 2, 2, 4, 4, 10, 10));
            Assert.IsTrue(Earcut.PointInTriangle(0, 0, 2, 2, 4, 4, 1, 1));
        }
    }
}
